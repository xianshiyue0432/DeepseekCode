...
declare global {
  interface Window {
    deepseekDesktop: {
      ...
      createFileSnapshot: (payload: { messageId: string; workspacePath: string }) => Promise<FileSnapshot>;
      getFileSnapshots: (workspacePath: string) => Promise<FileSnapshot[]>;
      rollbackToSnapshot: (payload: { snapshotId: string; workspacePath: string }) => Promise<RollbackResult>;
      undoRollback: (payload: { undoSnapshotId: string; workspacePath: string }) => Promise<RollbackResult>;
